                    ...
                    <div class="about-content text-center mb-55">
                        <div class="section-title mb-30">
                            ...
                            <h2 class="mb-15 wow fadeInUp" data-wow-delay=".4s">
                                Tous les documents publics du Ministère
                            </h2>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                <td> 
                                                    <p style="color: #212529;font-size: 16px;">
                                                        Du {{ \Carbon\Carbon::parse($doc->date)->translatedFormat('d F Y') }}
                                                        
                                                    </p>
                                                    {{-- à {{ $doc->created_at->format('H:i') }} --}} </td>
                                                <td>
                                                ...
                                                <td>
                                                    {{-- <a href="uploads/{{ $doc->pdf }}">
                                                        <button type="button" class="btn btn-outline-primary">Ouvrir</button>
                                                    </a> --}}
                                                     <a href="uploads/{{ $doc->pdf }}" class="btn bg-secondaryColor white" style="font-size: 12px;">
                                                        <span class="iconify fz-3" data-icon="bi:file-pdf-fill" data-inline="false">
                                                        </span>
                                                        Télécharger
                                                    </a>
                                                </td>
