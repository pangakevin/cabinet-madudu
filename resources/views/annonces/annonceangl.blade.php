            ...
            <i class="lni-menu"></i>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link page-scroll active" href="#">Actualités</a>
                        </li>
                                ...
                                @foreach ($articles as $article)
                                    <li class="list-group-item ">
                                        <span class="primaryColor">
                                           Du {{ \Carbon\Carbon::parse($article->created_at)->translatedFormat('d F Y') }}
                                            {{-- {{ $article->updated_at->diffForHumans() }} --}}
                                        </span>
                                        <br>
                                        <strong>
                                            <a href="{{ route('annonces.show', $article->slug) }}"
                                                style="text-align: justify;">{{ $article->titre }}
                                            </a>
                                        ...
                                        {{-- @empty
                                            <br>Pas d'articles pour le moment --}}
                                    </li>
                ...
                <div class="col-lg-4 col-md-12 border-left-secondaryColor">
                    <div class="">
                        ...
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <ul class="list-group">
                                @forelse ($articlescats as $articlescat)

                                {{-- <li class="list-group-item d-flex justify-content-between align-items-center"> --}}
                                    <a href="{{ route('actufiltrcat',['id'=>$articlescat->id]) }}"
                                        class="list-group-item list-group-item-action">
                                        {{ $articlescat->nom }}
                                        
                                    </a>
                                  {{-- <span class="badge badge-primary badge-pill">3 m {{ $articlescat->count('id') }}</span> --}}
                                  @empty
                                            <br>Pas de categorie
                                {{-- </li> --}}
                                @endforelse
